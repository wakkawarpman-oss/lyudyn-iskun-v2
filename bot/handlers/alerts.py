...
async def cmd_start(message: types.Message):
    greeting = (
        ...
        "📻 <b>SIGINT РАДІОПЕРЕХОПЛЕННЯ (WebSDR / KiwiSDR)</b>\n"
        "↳ <i>Суть:</i> Кореляція радіоефіру та перехоплень тактичних військових частот із текстовими повідомленнями каналів моніторингу.\n\n"
        "🗺️ <b>NOTAMs АНАЛІЗ</b>\n"
