...
async def cmd_start(message: types.Message):
    greeting = (
        "🛡️ <b>ОКІНТ-ПРО — ТАКТИЧНИЙ OSINT-АРСЕНАЛ КИЄВА ТА ОБЛАСТІ</b>\n"
        "<i>«ЗБИРАЄМО • АНАЛІЗУЄМО • ПЕРЕМАГАЄМО»</i>\n\n"
        "Платформа безперервно агрегує радарні потоки, супутникові дані та ШІ-аналіз. "
        "Ось короткий список інструментів та їхня суть:\n\n"
        "🟢 <b>ВІДБІЙ МОНІТОРИНГ</b> (<code>/vidbiy</code>)\n"
        "↳ <i>Суть:</i> Миттєво фіксує найшвидше підтвердження відбою тривоги. Ви першими знаєте, коли відкриваються магазини, ТРЦ, кафе та відновлює рух наземний транспорт.\n\n"
        "🛸 <b>РАДАР «КОНТУР» / NEPTUN</b> (<code>/radar</code>)\n"
        "↳ <i>Суть:</i> Живий радар повітряних цілей у небі України. Визначення швидкості, курсу БпЛА та розрахунок часу підльоту до Києва (Dead Reckoning).\n\n"
        "🔥 <b>СУПУТНИК NASA FIRMS</b> (<code>/satellite</code>)\n"
        "↳ <i>Суть:</i> Орбітальний тепловий моніторинг (VIIRS) — оперативна детекція пожеж, вибухів та термічних аномалій після прильотів.\n\n"
        "🎯 <b>ПРОГНОЗ ЗАГРОЗ</b> (<code>/threats</code>)\n"
        "↳ <i>Суть:</i> Оперативне зведення загроз балістики, вильотів стратегічної авіації РФ (Ту-95МС, МіГ-31К) та ймовірних векторів ударів.\n\n"
        "🕸️ <b>МЕРЕЖА ТА ІПСО</b> (<code>/network</code>)\n"
        "↳ <i>Суть:</i> Граф зв'язків та пересилань (Telerecon Core) для виявлення скоординованих інформаційних вкидів, паніки та ворожих ботоферм.\n\n"
        "🎖 <b>КЛЮЧОВІ ІНЦИДЕНТИ ТА ЗВІТ</b> (<code>/top</code>, <code>/report</code>)\n"
        "↳ <i>Суть:</i> Перевірена хронологія подій за 12–24 год із прив'язкою до критичної інфраструктури (підстанції, нафтобази, вузли зв'язку).\n\n"
        "🌐 <b>ТАКТИЧНА ВЕБ-МАПА</b>\n"
        "↳ <i>Суть:</i> Повноцінний геодашборд у браузері з живими векторами цілей, зонами радіозавад РЕБ, термоточками та укриттями.\n\n"
        "📸 <b>МУЛЬТИМОДАЛЬНИЙ VISION AI</b>\n"
        "↳ <i>Суть:</i> Надішліть боту фото чи відео прильоту — нейромережа визначить точні координати, тип ураження та руйнування.\n\n"
        "👇 <b>Оберіть потрібний інструмент на клавіатурі:</b>"
    )
