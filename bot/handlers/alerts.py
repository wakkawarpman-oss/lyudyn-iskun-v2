...
async def cmd_start(message: types.Message):
    greeting = (
        ...
        "📹 <b>ОПТИЧНА РОЗВІДКА CCTV</b> (<code>/layers</code>)\n"
        "↳ <i>Суть:</i> Вузли відеоспостереження та аналітики ТОТ (Донецьк, Севастополь, Луганськ, Енергодар) та прифронтового моніторингу (Харків).\n\n"
