    ...
    try:
        ...
        try:
            await bot.set_my_description(
                description=(
                    "🛡️ ОКІНТ-ПРО — Тактичний OSINT-моніторинг Києва та області 24/7.\n\n"
                    "«ЗБИРАЄМО • АНАЛІЗУЄМО • ПЕРЕМАГАЄМО»\n\n"
                    "⚡ БОЙОВИЙ ФУНКЦІОНАЛ:\n"
                    "• 🛸 Живий радар БпЛА (Neptun Live)\n"
                    "• 🔥 Супутниковий моніторинг пожеж (NASA FIRMS)\n"
                    "• 🕸️ Аналізатор зв'язків та ІПСО (Telerecon)\n"
                    "• 🎯 Геоприв'язка інцидентів (OSM + GeoSpy)\n"
                    "• 🛰️ Тактична веб-карта загроз\n"
                    "• 🔔 Моніторинг сигналу «ВІДБІЙ ТРИВОГИ»\n"
                    "• 👁️ Комп'ютерний зір Vision AI\n\n"
                    "Команди: /threats, /network, /radar, /help"
                )
            )
