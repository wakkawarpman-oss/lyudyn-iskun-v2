...
MEME_DATABASE = {
    ...
    "man": [
        ...
        "<b>[КИЇВСЬКИЙ DATING 2026]</b>\n— Привіт, Людо! Що робиш?\n— Перевіряю звіт від Іскуна.\n— А Люді мужик не потрібен?\n— Люда сама пише звіти Іскуна і чекає на мужика!",
        "<b>[ХАРАКТЕРИСТИКА ОБ'ЄКТА]</b>\nЛюда шукає чоловіка з трьома базовими характеристиками: <b>живий, адекватний, не летить на неї з аеродрому.</b> Четверта — щоб сам іноді писав першим.",
