...
4. 🎯 **Пріоритет 1 — Edge MLX Інференс на Apple Silicon:**
   - Автономний запуск квантованої локальної LLM для повністю ізольованих контурів.
5. 🎯 **Пріоритет 2 — Екстраполяція траєкторій дронів (Kalman Tracker):**
   - Використання векторів швидкості БпЛА для розрахунку прогнозованого часу підльоту (ETA).
