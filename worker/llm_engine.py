...
1. "Мурашники", щільна панельна 20-30-поверхова забудова -> Лівий берег (Позняки, Осокорки, Харківський).
2. Сталінки, урядові монументальні будівлі з ліпниною -> Печерськ або Липки.
3. Історична низька забудова (2-5 поверхів), вузькі вулиці, цегла -> Поділ або Золоті Ворота.
4. Хрущовки 5 поверхів потопають у зелених деревах -> Сирець, Нивки, Солом'янка або Дарниця.
5. Сучасні ЖК бізнес-класу зі скляними фасадами -> Новопечерські Липки, Французький квартал (Печерськ) або Рибальський.
