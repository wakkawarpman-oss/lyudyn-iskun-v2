...
# Replace any weird physical newlines inside strings with actual \n characters
# Let's just hardcode the replacement for cmd_ops_events
good = """
...
"""
import re
text = re.sub(r'@router\.message\(Command\("ops"\)\).*', good, text, flags=re.DOTALL)
